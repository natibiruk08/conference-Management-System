...
import my from './images/register.svg';
            ...
            <div className="background-workshop">
                ...
                <div className="container mt-4 shadow p-3 mb-5 bg-body rounded">
                    ...
                    <div className="p-3">
                        ...
                        <h1 data-testid='title-field'>Conference Registration</h1>
                        <div className="container p-3">
                            <form onSubmit={this.onSubmit} className="row g-3" data-testid='form-tag'>
                                ...
                                <div className="col-12">
                                    <label htmlFor="workShopTitle" className="form-label">Title of the Conference</label>
                                    <input
                                        type="text"
                                        className="form-control"
                                        id="workShopTitle"
